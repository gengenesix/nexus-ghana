...
const DEFAULT_ACCOUNTS = [
  ...
  // Income
  { account_code: "4000", name: "Sales Revenue", account_type: "income" },
  { account_code: "4100", name: "Service Revenue", account_type: "income" },
  { account_code: "4200", name: "Interest Income", account_type: "income" },
  { account_code: "4300", name: "Other Income", account_type: "income" },
  { account_code: "4400", name: "Discount Received", account_type: "income" },
  // Expenses
...
export default function SeedChartOfAccounts() {
  ...
  const seed = useMutation({
    ...
    onSuccess: () => {
      ...
      toast.success("Ghana-standard Chart of Accounts created with 36 accounts");
    },
