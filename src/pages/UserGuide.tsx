...
const sections: GuideSection[] = [
  ...
  },
  {
    ...
    steps: [
      { heading: "Adding staff", body: "Click Add Staff and fill in the name, role, email, and a temporary password. The system auto-generates a unique 8-digit Staff ID. Share the Business Access Code, Staff ID, and password with the staff member — they use these to log in." },
      { heading: "Staff login", body: "Staff log in at the Sign In page using the Staff Login tab. They enter their Business Access Code, 8-digit Staff ID, and password. Credentials are personal — no shared devices, no PINs." },
      { heading: "Joining your business (owner-created staff)", body: "If you created the account via Add Staff, the staff member already belongs to your business. They do not need a join code — just log in with the credentials you provided." },
